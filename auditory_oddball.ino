...
if (button.fell()) {
  ...
  //after the first button press the administration will be interrupted when all stimuli have been presented or the button is pressed again
    ...
    if (timer(1000)) { //setting the timer (function below) to 1s
...
//creating a timer function which goes off every second (in this case), giving the time for the stimuli administration
